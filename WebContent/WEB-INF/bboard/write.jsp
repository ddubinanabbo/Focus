...
<form id="writeForm" name="writeForm" method="post" action="" enctype="multipart/form-data">
      ...
      <div class="container-fluid">
          <table class="table">
            <tr>
               <td >제목</td>
               <td colspan="5"><input id="subject" name="subject" type="text" size="50" placeholder="제목을 입력하세요!"></td>               
               <td></td>
            </tr>
            <tr>
            	<td>
           ...
           <tr>
                <td colspan="7">
                <p>글 내용</p>
                <textarea id="content" name="content" rows="6" cols="140" placeholder="내용을 입력하세요"></textarea>                             
                </td>                
